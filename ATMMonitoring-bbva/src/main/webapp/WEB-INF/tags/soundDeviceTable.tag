<%@tag description="Sound Device Table" pageEncoding="UTF-8"%>
<%@attribute name="hardwareDevices" required="true" type="java.util.Set"%>
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<%@taglib uri="http://www.springframework.org/tags" prefix="spring"%>

<h3 class="txt content_hide"><spring:message code="label.soundDevices"/></h3>
...
<c:forEach items="${hardwareDevices}" var="hardwareDevice">
    <tr id="HardwareDeviceSDT.${hardwareDevice.id}.${hardwareDevice.startDate.time}">
